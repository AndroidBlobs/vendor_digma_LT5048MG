...
CUSTOM_HAL_IMGSENSOR = gc5025_mipi_raw gc2385_mipi_raw gc2385s_mipi_raw gc030a_mipi_raw
CUSTOM_HAL_LENS = dummy_lens dummy_lens dummy_lens dummy_lens
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = gc2385_mipi_raw
...
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR = gc030a_mipi_raw
CUSTOM_HAL_SUB_BACKUP_LENS = dummy_lens
CUSTOM_HAL_SUB_IMGSENSOR = gc2385s_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = gc5025_mipi_raw gc2385_mipi_raw gc2385s_mipi_raw gc030a_mipi_raw
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dummy_lens dummy_lens dummy_lens dummy_lens
#CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = gc2385_mipi_raw
...
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR = gc030a_mipi_raw
CUSTOM_KERNEL_SUB_BACKUP_LENS = dummy_lens
CUSTOM_KERNEL_SUB_IMGSENSOR = gc2385s_mipi_raw
CUSTOM_KERNEL_SUB_LENS = dummy_lens
CUSTOM_KERNEL_TOUCHPANEL = GSL1691
...
MTK_BUILD_VERNO = alps-mp-o1.mp2-V1.82_k80hd.bsp.fwv.512m_TMP1
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
BIRD_BUILD_PRODUCT = LT5048MG
BIRD_PRODUCT_NAME=LINX_JOY_3G
BIRD_PRODUCT_BRAND=DIGMA
BIRD_PRODUCT_BOARD=LT5048MG
BIRD_PRODUCT_MODEL=LINX JOY 3G LT5048MG
BIRD_PRODUCT_DEVICE=LT5048MG
BIRD_PRODUCT_MANUFACTURER=DIGMA
BIRD_BT_STRING = LINX_JOY_3G 
BIRD_WLAN_DIRECT_NAME = LINX_JOY_3G
BIRD_WLAN_SSID_STRING = LINX_JOY_3G
BIRD_USB_DRIVER_STRING= LINX_JOY_3G
BIRD_MTP_MANUFACTURER = LINX_JOY_3G
BIRD_MTP_MODEL = LINX_JOY_3G
BIRD_MTP_LABEL = LINX_JOY_3G
BIRD_PTP_MODEL = LINX_JOY_3G
BIRD_NET_HOSTNAME= LINX_JOY_3G
BIRD_CUSTOM = 7130D_S5017D_E_DS442_DIGMA
BIRD_MEMORYDEVICELIST_DS = yes
#BIRD_MCP = DS883
BIRD_FIRST_LOGO = DIGMA_FWVGA_LOGO
BIRD_SECOND_LOGO = DIGMA_FWVGA_LOGO
BIRD_BOOT_ANIMATION=DIGMA_FWVGA_ANI
BIRD_DEFAULT_WALLPAPER=DIGMA_DEFAULT_WALLPAPER
BIRD_MAIN_IMGSENSOR = gc5025_gc0310_mipi_raw_7130D_S5017A_AM_DS842_FWVGA
BIRD_SUB_IMGSENSOR = gc2385s_mipi_raw_7130D_S5017A_AM_DS842_FWVGA
BIRD_MAIN_BACKUP_IMGSENSOR = gc2385_mipi_raw_7130D_S5017A_AM_DS842_FWVGA
BIRD_SUB_BACKUP_IMGSENSOR = gc030a_mipi_raw_7130D_S5017A_AM_DS842_FWVGA
#BIRD_SUB_FLASH_SUPPORT=yes
BIRD_WRITE_IMEI = yes
BIRD_CUSTOM_DIGMA_KEY=yes
#BIRD_OTA_ART_CASH_MODE=yes
...
######################### MMITest & FACTORYTest BEGIN ##############################
BIRD_MMITEST_OPEN_SUBCAMERA_FLASH = yes
#BIRD_MMITEST_VIEW_HARDWAREINFO = yes
#BIRD_HARDWARE_INFO = no
...
BIRD_MMI_TEST_SENSOR_SHOWCOLOR = yes
...
BIRD_FACTORY_POWERON_TEST_FINGERPRINT_WITH_PICTURE = yes
...
BIRD_MMI_AUTO_TEST_SENSOR_TIP_DIRECTION=yes
######################### MMITest & FACTORYTest END ##############################
BIRD_GAPPS_GO=yes
BIRD_DONT_CG_LAN_BYSIM=yes
BIRD_CAMERA_VOLUME_BUTTON_SETTINGS = photo
BIRD_SET_HOMEPAGE=yes
BIRD_LCD_DENSITY=240
BIRD_DEFAULT_PICTURE_RATIO_BACK=4:3
BIRD_DEFAULT_PICTURE_RATIO_FRONT=4:3
BIRD_MODIFY_KERNEL_VERSION=yes
BIRD_DISABLE_AUTO_BRIGHTNESS = yes
BIRD_DISABLE_CHARGING_SOUNDS = yes
BIRD_STORAGE_VOLUME_USED = no
BIRD_DEFAULT_STORAGE_SD = yes
BIRD_DEFAULT_STORAGE_OPEN = yes
BIRD_SHOW_BATTERY_PERECNT=yes
BIRD_PRESS_HOME_GOOGLE=yes
BIRD_GEMINI_DEFAULT_DATA_ON = yes
#BIRD_SIGNAL_3G_TO_H = yes
BIRD_MOBILE_TYPE_DATA = yes
#BIRD_PHONEINFO_SECRET_CODE=yes
#BIRD_DEVICE_PHONE_FCCID=2AO6ZK500
#BIRD_DEFAULT_CONNECTION_MTP=yes
BIRD_ADD_AM_PM_STYLE=yes
BIRD_BASEBAND_NOTIME=yes
BIRD_DATA_INDICATOR_ARROW=yes
MTK_SOUNDRECORDER_APP=yes
#ADUPS_FOTA_SUPPORT=yes
#ADUPS_FOTA_WITH_ICON=no
#ADUPS_FOTA_WITHOUT_MENU=no
BIRD_DISABLE_UPDATE_INSETTINGS=yes
BIRD_BUILD_VERSION_TAGS = release-keys
BIRD_ACCELEROMETER_ROTATION_DEFAULT_ON=yes
BIRD_SSB_NET_ICON_HIDE=yes
BIRD_FM_DEFAULT_STATION = 1043
BIRD_SSB_NET_ICON_HIDE = yes
#BIRD_SOUNDRECORDER_CALLER_STORAGE=no
#BIRD_EPIK_Mar29=yes
#BIRD_OPEN_EPIK_APK=yes
BIRD_SHOW_AGING_TEST = no
BIRD_FAKE_LEISA_ROM = 4096
BIRD_PARA_INFO_CONFIG = 7130D_S5017A_AM_DS842_FWVGA
BIRD_LOAD_CUSTOM_VOICE_MAIL = yes
BIRD_LAUNCHER_SETTINGS = yes
BIRD_HIDE_SIMCARD_PREF=yes
BIRD_REMOVE_EVERY_TIME_ASK = yes

BIRD_BUILD_NUMBER = Digma_LINX_JOY_3G_V1.1_$(shell date +%Y%m%d)
BIRD_BUILD_DISPLAY_ID=Digma_LINX_JOY_3G_V1.1_$(shell date +%Y%m%d)
BIRD_EM_VERNO = Digma_LINX_JOY_3G_V1.1_$(shell date +%Y%m%d)
BIRD_INNER_SW_VERSION = 7130D_S5017D_AM.A1.$(shell date +%Y%m%d).AD80.V21.FWVGA.DS44.B18.MP.RU
#BIRD_HW_VERSION = 7130D_S5017D_AM.A1.$(shell date +%Y%m%d).AD80.V21.FWVGA.DS44.B18.SP.RU
#BIRD_COPY_5017A = yes
